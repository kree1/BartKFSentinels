...
namespace BartKFSentinels.Impulse
{
    public class AirPocketCardController : ImpulseUtilityCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            AddTrigger<DealDamageAction>((DealDamageAction dda) => !dda.IsPretend && dda.Target == GetCardThisCardIsNextTo() && dda.Amount > 0 && !base.Card.IsBeingDestroyed, DealtDamageResponse, new TriggerType[] { TriggerType.DestroySelf }, TriggerTiming.Before);
