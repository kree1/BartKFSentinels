...
namespace BartKFSentinels.Ownership
{
    public class SunSunCardController : OwnershipUtilityCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            AddTrigger((DealDamageAction dda) => IsHeroCharacterCard(dda.Target) && dda.DamageType == DamageType.Fire && dda.FinalAmount >= 4 && dda.DidDealDamage, (DealDamageAction dda) => DealDamage(base.Card, base.Card, 3, DamageType.Infernal, cardSource: GetCardSource()), TriggerType.DealDamage, TriggerTiming.After);
