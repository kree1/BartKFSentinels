...
namespace BartKFSentinels.Ownership
{
    public class SunSunCardController : OwnershipUtilityCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            AddTrigger((PlayCardAction pca) => pca.WasCardPlayed && IsVillain(pca.CardToPlay) && base.GameController.GetAllKeywords(pca.CardToPlay).Contains(SunKeyword), (PlayCardAction pca) => DealDamage(base.Card, base.Card, 5, DamageType.Infernal, cardSource: GetCardSource()), TriggerType.DealDamage, TriggerTiming.After);
        }
    }
}
