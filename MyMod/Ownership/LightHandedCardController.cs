...
namespace BartKFSentinels.Ownership
{
    public class LightHandedCardController : TeamModCardController
    {
            ...
            : base(card, turnTakerController)
        {
            ...
            SpecialStringMaker.ShowNumberOfCardsAtLocation(base.Card.Location.HighestRecursiveLocation, new LinqCardCriteria((Card c) => IsEquipment(c) || (!c.IsCharacter && c.IsTarget), "Equipment and non-character target"), recursive: true);
        }
