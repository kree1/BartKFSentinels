    ...
    public class RightOfWayCardController : CardController
    {
        ...
        public override IEnumerator Play()
        {
            ...
            else
            {
                ...
                //Log.Debug("RightOfWayCardController.Play(): no cards revealed");
                IEnumerator emptyCoroutine = base.GameController.SendMessageAction(environmentDeck.OwnerName + " is deserted, so " + base.TurnTaker.Name + " has the " + base.Card.Title + "!", Priority.Medium, GetCardSource());
                if (base.UseUnityCoroutines)
                {
                    yield return base.GameController.StartCoroutine(emptyCoroutine);
                }
                else
                {
                    base.GameController.ExhaustCoroutine(emptyCoroutine);
                }
            }
            ...
            /*else
            {
                Log.Debug("RightOfWayCardController.Play(): no unplayed revealed cards found");
            }*/
            //Log.Debug("RightOfWayCardController.Play(): reshuffling finished");
            ...
            //Log.Debug("RightOfWayCardController.Play(): method ends");
