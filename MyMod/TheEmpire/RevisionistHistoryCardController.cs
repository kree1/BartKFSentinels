...
namespace BartKFSentinels.TheEmpire
{
    public class RevisionistHistoryCardController : EmpireUtilityCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            AddIncreaseDamageTrigger((DealDamageAction dda) => dda.DamageSource != null && dda.DamageSource.IsCard && dda.DamageSource.Card.DoKeywordsContain(AuthorityKeyword), (DealDamageAction dda) => 1);
