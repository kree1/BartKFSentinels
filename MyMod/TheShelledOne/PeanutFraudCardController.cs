...
namespace BartKFSentinels.TheShelledOne
{
    public class PeanutFraudCardController : StrikeCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            AddTrigger((ReduceDamageAction rda) => IsHeroTarget(rda.DealDamageAction.Target), (ReduceDamageAction rda) => base.GameController.GainHP(base.Card, 1, cardSource: GetCardSource()), TriggerType.GainHP, TriggerTiming.After);
