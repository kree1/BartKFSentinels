...
namespace BartKFSentinels.TheShelledOne
{
    public class IdolatryCardController : StrikeCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            AddTrigger<PlayCardAction>((PlayCardAction pca) => pca.CardSource != null && pca.CardSource.Card.Owner.IsHero && pca.DecisionMaker.IsHero && pca.ResponsibleTurnTaker.IsHero && pca.DecisionMaker.TurnTaker != pca.ResponsibleTurnTaker && !pca.IsPutIntoPlay, (PlayCardAction pc) => base.GameController.GainHP(base.Card, 1, cardSource: GetCardSource()), TriggerType.GainHP, TriggerTiming.After);
