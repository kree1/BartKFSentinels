...
namespace BartKFSentinels.Fracture
{
    public class LeadByNecessityCardController : FractureUtilityCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            AddTrigger((DealDamageAction dda) => !HasBeenSetToTrueThisTurn(OncePerTurn) && dda.Target != null && dda.Target.IsHero && dda.DidDealDamage, ReduceRetaliateResponse, new TriggerType[] { TriggerType.CreateStatusEffect, TriggerType.DealDamage }, TriggerTiming.After);
        }
