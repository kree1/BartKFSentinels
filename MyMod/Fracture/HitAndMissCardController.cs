...
namespace BartKFSentinels.Fracture
{
    public class HitAndMissCardController : FractureUtilityCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            AddTrigger((DealDamageAction dda) => !base.IsBeingDestroyed && dda.DamageSource != null && dda.DamageSource.Card != null && dda.DamageSource.Card.IsTarget && !dda.DamageSource.Card.IsHero, DestructResponse, new TriggerType[] { TriggerType.DestroySelf, TriggerType.ReduceDamage }, TriggerTiming.Before);
        }
