...
namespace BartKFSentinels.Dreadnought
{
    public class TougherThanABattlecruiserCardController : StressCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            // "Whenever a target is reduced from 1 or more to 0 or fewer HP or an environment card is destroyed, {Dreadnought} deals herself 2 irreducible psychic damage unless you put the bottom card of your trash on the bottom of your deck."
            ...
            AddTrigger((DestroyCardAction dca) => dca.WasCardDestroyed && dca.CardToDestroy.Card.IsEnvironment, (DestroyCardAction dca) => PayStress(1), new TriggerType[] { TriggerType.MoveCard, TriggerType.DealDamage }, TriggerTiming.After);
        }
    }
}
