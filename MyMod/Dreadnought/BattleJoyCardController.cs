...
namespace BartKFSentinels.Dreadnought
{
    public class BattleJoyCardController : CardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            AddTrigger((DealDamageAction dda) => dda.DamageSource != null && dda.DamageSource.IsSameCard(CharacterCard) && dda.DidDealDamage, (DealDamageAction dda) => GameController.GainHP(CharacterCard, 1, cardSource: GetCardSource()), TriggerType.GainHP, TriggerTiming.After);
