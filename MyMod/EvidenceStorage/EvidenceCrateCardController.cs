...
namespace BartKFSentinels.EvidenceStorage
{
    public class EvidenceCrateCardController : EvidenceStorageUtilityCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            base.AddTrigger<DealDamageAction>((DealDamageAction dda) => dda.DamageSource != null && dda.DamageSource.IsCard && dda.DamageSource.IsTarget && !dda.DamageSource.IsEnvironmentSource && dda.Target == base.Card && dda.FinalAmount > 0 && !dda.IsPretend, OpenCrateResponse, new TriggerType[] { TriggerType.DiscardCard, TriggerType.PutIntoPlay }, TriggerTiming.After, isActionOptional: false);
            base.AddTriggers();
        }
