...
{
    public class EyesLikeTelescopesCardController : StressCardController
    {
        public EyesLikeTelescopesCardController(Card card, TurnTakerController turnTakerController)
