...
{
    public class TitanicImpactCardController : StressCardController
    {
        public TitanicImpactCardController(Card card, TurnTakerController turnTakerController)
        ...
        {
            // "{Victory} deals 1 target 7 irreducible projectile damage."
            ...
            // "If you moved 2 or fewer cards to your deck this way, {Victory} deals herself 3 irreducible toxic damage."
            if (cardsMoved <= 2)
            {
