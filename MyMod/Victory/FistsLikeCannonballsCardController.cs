...
{
    public class FistsLikeCannonballsCardController : StressCardController
    {
        public FistsLikeCannonballsCardController(Card card, TurnTakerController turnTakerController)
