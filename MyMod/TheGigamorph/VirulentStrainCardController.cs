...
namespace BartKFSentinels.TheGigamorph
{
    public class VirulentStrainCardController : TheGigamorphUtilityCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            base.AddIncreaseDamageTrigger((DealDamageAction dda) => dda.DamageSource.IsCard && dda.DamageSource.Card.DoKeywordsContain("pathogen"), 1);
            ...
            base.AddTrigger<DealDamageAction>((DealDamageAction dda) => dda.DidDealDamage && dda.DamageSource != null && dda.DamageSource.IsCard && dda.DamageSource.Card == base.Card && dda.TargetHitPointsAfterBeingDealtDamage <= 0, HealAttackResponse, new TriggerType[] { TriggerType.GainHP, TriggerType.DealDamage }, TriggerTiming.After);
            base.AddTriggers();
        }
