...
{
    public class QuickerThanTheMindCardController : PalmreaderUtilityCardController
    {
        public QuickerThanTheMindCardController(Card card, TurnTakerController turnTakerController)
