...
namespace BartKFSentinels.Palmreader
{
    public class SignalFlareCardController : PalmreaderUtilityCardController
    {
        ...
        {
            // "{PalmreaderCharacter} deals each non-hero target 2 psychic damage."
            IEnumerator damageCoroutine = DealDamage(base.CharacterCard, (Card c) => !IsHeroTarget(c), 2, DamageType.Psychic, optional: false);
